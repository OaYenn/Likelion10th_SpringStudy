...
function addHTML(itemDto) {
    ...
    return `<div class="search-itemDto">
        ...
        <div class="search-itemDto-right">
            <img src="../../../../Likelion10th_SpringStudy/session/week04/src/main/resources/static/images/icon-save.png" alt="" onclick='addProduct(${JSON.stringify(itemDto)})'>
        </div>
    </div>`
}
...
function addProduct(itemDto) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $('#container').addClass('active'); // modal 뜨게 하기
